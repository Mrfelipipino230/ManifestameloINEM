...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($titulo) && !empty($mensaje)) {
        ...
        $sql = "INSERT INTO musica (usuario, unique_id, titulo, mensaje, imagen, video, fecha) VALUES ('$autor','$unique_id', '$titulo', '$mensaje', '$imagen', '$video', NOW())";
...
<div class="mensajes">
    <div class="cop">
        <?php
        $sql = "SELECT p.*, u.img FROM musica p JOIN users u ON p.unique_id = u.unique_id ORDER BY p.fecha DESC";
