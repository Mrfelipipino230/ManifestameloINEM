    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li><a href="perfil.php"><img src="php/images/<?php echo $row['img']; ?>" alt="" width="60" height="60" class="rounded-circle"></li></a>
            </ul>
...
if (!isset($_GET['id'])) {
    die("Error: Post no especificado.");
}

$post_id = $_GET['id'];

// hace consultas a varias tablas
$tables = ['publications', 'arte', 'chisme', 'geek', 'juegos', 'musica', 'comida'];
$post_found = false;

foreach ($tables as $table) {
    $sql_post = "SELECT * FROM $table WHERE id_publications = '$post_id'";
