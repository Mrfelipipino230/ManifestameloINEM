            ...
            <div class="perfil-usuario-footer">
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="cambinickname">
                        ...
                        <input type="text" name="fname" placeholder="Nuevo nombre" value="<?php echo $row['fname'];?>">
                    </div>
                    <div class="cambinickname">
                        <label>Cambiar nickname:</label>
                        <input type="text" name="lname" placeholder="Nuevo nickname" value="<?php echo $row['lname'];?>">
                    </div>
                    <div class="cambioimg">
